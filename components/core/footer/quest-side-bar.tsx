...
export function QuestSideBar({ }: QuestSideBarProps) {
    const { questOwner, questName, selectedQuest, questStructure, questPoap } = useQuest();
    ...
    return (
        <Sheet open={sheetOpen} onOpenChange={setSheetOpen}>
            ...
            <SheetContent
                side="left"
                className="w-[400px] sm:w-[540px] rounded-r-lg flex flex-col justify-between"
            >
                <div>
                    <SheetHeader>
                        <SheetTitle className="mb-4">
                            {questPoap?.title || questName || "Menu"}
                        </SheetTitle>
                    </SheetHeader>
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <a
                            className="flex items-center gap-2 cursor-pointer hover:text-primary"
                            target="_blank"
                            href={`https://github.com/${questOwner}/${questName}/discussions`}
                        >
                            <Github /> Discussion
                        </a>
                        {/* <div>
